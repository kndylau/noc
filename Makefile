...
#dump table create
	...
	mysqldump --compact -d --default-character-set=latin1 noc IP JF_CAB JF_Server ODF ODFPAN file file_del hist info jifang_daily ticket ticketdetail user userright > noc.sql
